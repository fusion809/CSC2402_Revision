...
def main():
    ...
    plt.savefig("SimplePendulum/Figure_1:_Euler_solution_to_simple_pendulum.svg")
    ...
    plt.savefig("SimplePendulum/Figure_2:_Modified_Euler_solution_to_simple_pendulum.svg")
    ...
    plt.savefig("SimplePendulum/Figure_3:_RK4_solution_to_simple_pendulum.svg")
    ...
    plt.savefig("SimplePendulum/Figure_4:_theta_values_obtained_with_four_different_numerical_schemes.svg")
    ...
    plt.savefig("SimplePendulum/Figure_5:_RKF45_solution_to_simple_pendulum.svg")
    ...
    plt.savefig("SimplePendulum/Figure_6:_theta_dot_values_comparison.svg")
